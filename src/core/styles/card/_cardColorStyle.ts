...
export function _cardColorStyle(
  ...
  return {
    ...
    '--card-badge-default-border-color': color.badge.default.border,
    ...
    '--card-badge-primary-border-color': color.badge.primary.border,
    ...
    '--card-badge-positive-border-color': color.badge.positive.border,
    ...
    '--card-badge-caution-border-color': color.badge.caution.border,
    ...
    '--card-badge-critical-border-color': color.badge.critical.border,
