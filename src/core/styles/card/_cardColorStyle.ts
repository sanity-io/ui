...
export function _cardColorStyle(
  ...
  return {
    ...
    '--card-badge-potential-bg-color': color.badge.potential.bg,
    '--card-badge-potential-dot-color': color.badge.potential.dot,
    '--card-badge-potential-fg-color': color.badge.potential.fg,
    '--card-badge-potential-icon-color': color.badge.potential.icon,
