...
import {DEFAULT_TOOLTIP_ARROW_SIZE} from './constants'

const Root = styled.div`
  position: absolute;
  pointer-events: none;
  width: ${DEFAULT_TOOLTIP_ARROW_SIZE}px;
  height: ${DEFAULT_TOOLTIP_ARROW_SIZE}px;
  fill: none;
  ...
  & > svg {
    display: block;
    transform-origin: ${DEFAULT_TOOLTIP_ARROW_SIZE / 2}px ${DEFAULT_TOOLTIP_ARROW_SIZE / 2}px;
  }
...
export const TooltipArrow = forwardRef(function TooltipArrow(
  ...
  return (
    <Root data-ui="Tooltip__arrow" {...restProps} ref={ref}>
      <svg
        width={DEFAULT_TOOLTIP_ARROW_SIZE}
        height={DEFAULT_TOOLTIP_ARROW_SIZE}
        viewBox="0 0 15 15"
      >
