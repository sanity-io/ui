...
export const cardRules: Rules = {
  card: {
    ...
    '--card-bg2-color': vars.color.tinted.default.bg[1],
    '--card-border-color': vars.color.border,
    '--card-code-bg-color': vars.color.tinted.default.bg[1],
    ...
    '--card-kbd-bg-color': vars.color.tinted.default.bg[1],
    '--card-kbd-border-color': vars.color.tinted.default.border[1],
    '--card-kbd-fg-color': vars.color.tinted.default.fg[4],
    '--card-link-color': vars.color.link.fg,
    '--card-link-fg-color': vars.color.link.fg,
    '--card-muted-bg-color': vars.color.tinted.default.bg[1],
    '--card-muted-fg-color': vars.color.tinted.default.fg[4],
