...
export const Root = styled.div(
  ({theme}) => css`
    ...
    .button {
      ...
      color: var(--fg);
      box-shadow:
        inset 0 0 0 ${theme.sanity.button.border.width}px var(--border),
        0 ${theme.sanity.button.border.width + 1}px 0 0
          color-mix(in srgb, var(--border), transparent 75%);
      text-align: center;
      border-radius: 3px;
      font-weight: 500;
      cursor: default;
      ...
      &:active {
        ...
        box-shadow: inset 0 0 0 ${theme.sanity.button.border.width}px var(--border);
    ...
    .card {
      background-color: var(--bg);
      color: var(--fg);
      box-shadow: inset 0 0 0 ${theme.sanity.card.border.width}px var(--border);
      /* text-align: center; */
      border-radius: 3px;
      font-weight: 500;
      cursor: default;
      ...
      &:focus-visible {
        outline: none;
        box-shadow:
          inset 0 0 0 ${theme.sanity.card.border.width}px var(--border),
          0 0 0 1px var(--base-bg),
          0 0 0 3px var(--focus-ring);
