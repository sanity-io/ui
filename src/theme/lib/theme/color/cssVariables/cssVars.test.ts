...
describe('css variables', () => {
  it('Should create the variables when no default tone is provided', () => {
    ...
    const expected = {
      ...
      '--spot-green': '#26a130',
      '--spot-cyan': '#15ac93',
      '--syntax-atrule': '#8238c2',
      '--syntax-attrName': '#157e1e',
      '--syntax-attrValue': '#9f760f',
      '--syntax-attribute': '#9f760f',
      '--syntax-boolean': '#8238c2',
      '--syntax-builtin': '#8238c2',
      '--syntax-cdata': '#9f760f',
      '--syntax-char': '#9f760f',
      '--syntax-class': '#be4c0e',
      '--syntax-className': '#099079',
      '--syntax-comment': '#8d96a5',
      '--syntax-constant': '#8238c2',
      '--syntax-deleted': '#b5291c',
      '--syntax-doctype': '#8d96a5',
      '--syntax-entity': '#b5291c',
      '--syntax-function': '#157e1e',
      '--syntax-hexcode': '#166bfe',
      '--syntax-id': '#8238c2',
      '--syntax-important': '#8238c2',
      '--syntax-inserted': '#9f760f',
      '--syntax-keyword': '#c3185a',
      '--syntax-number': '#8238c2',
      '--syntax-operator': '#c3185a',
      '--syntax-prolog': '#8d96a5',
      '--syntax-property': '#166bfe',
      '--syntax-pseudoClass': '#9f760f',
      '--syntax-pseudoElement': '#9f760f',
      '--syntax-punctuation': '#5e6673',
      '--syntax-regex': '#166bfe',
      '--syntax-selector': '#b5291c',
      '--syntax-string': '#9f760f',
      '--syntax-symbol': '#8238c2',
      '--syntax-tag': '#b5291c',
      '--syntax-unit': '#be4c0e',
      '--syntax-url': '#b5291c',
      '--syntax-variable': '#b5291c',
