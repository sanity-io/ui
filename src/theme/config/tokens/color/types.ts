...
export type StatesColorTokens = Partial<Record<ColorConfigState, StateColorTokens>>

export interface ButtonColorTokens
  extends Partial<Record<ColorConfigStateTone, StatesColorTokens>> {
  _hue?: ColorHueValue
}
...
export interface ColorTokens {
  ...
  selectable?: Partial<Record<ColorConfigStateTone, {_hue?: ColorHueValue} & StatesColorTokens>>
