import {Box, Button, Card, rem, useClickOutside} from '@sanity/ui'
import React, {useState} from 'react'
import styled, {css} from 'styled-components'
import {ResourcesPageHeader} from './header'
...
export function ResourcesPageLayout({children}: {children: React.ReactNode}) {
