...
test.describe('Components/Dialog', () => {
  test('should open dialog', async ({page}) => {
    await page.goto('/iframe.html?id=components-dialog--props&viewMode=story')
  ...
  test('should trap focus', async ({page}) => {
    ...
    const closeButton = page.locator('#dialog button[aria-label="Close dialog"]')
  ...
  test('should focus last focused element when dialog becomes top layer', async ({page}) => {
    await page.goto('/iframe.html?id=components-dialog--activate&viewMode=story')
