    ...
    <Card padding={[3, 4]} tone={tone}>
      <Stack space={[3, 4]}>
        ...
        <Flex gap={1}>
          ...
          <Box flex={1} style={{backgroundColor: color.avatar?.purple.bg, width: 25, height: 25}} />
          <Box
            flex={1}
          ...
          <Box flex={1} style={{backgroundColor: color.avatar?.yellow.bg, width: 25, height: 25}} />
          <Box flex={1} style={{backgroundColor: color.avatar?.green.bg, width: 25, height: 25}} />
