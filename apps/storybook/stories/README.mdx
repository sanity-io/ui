...
- The Playwright end-to-end tests (in `e2e/` at the repository root) run against the built Storybook. Take care when renaming stories that are referenced by `page.goto()` calls.
