...
const nextConfig: NextConfig = {
  ...
  // The workspace @sanity/ui and @sanity/color resolve to their TypeScript
  // source in the monorepo (dev `exports`), so Next.js must transpile them.
  transpilePackages: ['@sanity/ui', '@sanity/color'],
  reactCompiler: true,
  experimental: {
