...
const nextConfig: NextConfig = {
  ...
  // The workspace @sanity/logos and @sanity/ui packages resolve to their
  // TypeScript source in the monorepo (dev `exports`), so Next.js must
  // transpile them.
  transpilePackages: ['@sanity/logos', '@sanity/ui'],
  reactCompiler: true,
  experimental: {
