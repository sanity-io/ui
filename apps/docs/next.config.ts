...
const nextConfig: NextConfig = {
  ...
  // The workspace @sanity/icons, @sanity/logos and @sanity/ui packages
  // resolve to their TypeScript source in the monorepo (dev `exports`), so
  // Next.js must transpile them.
