  ...
  transform: {
    '\\.[jt]sx?$': [
      'babel-jest',
      {
        ...
        // `@sanity/ui` resolves to its TypeScript source in the monorepo (dev
        // exports), so apply the React Compiler here to keep testing the same
        // compiled behavior that `tsdown` ships in `dist`
