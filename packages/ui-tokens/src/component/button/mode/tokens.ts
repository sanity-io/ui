  ...
  default: _defineTokens({
    button: {
      ...
      color: _defineTokenGroup({
        ...
        disabled: {
          bg: _colorAlias('{_tone.color.tinted.default.border.3}'),
          border: _colorAlias('{_tone.color.tinted.default.border.2}'),
          fg: _colorAlias('{_tone.color.tinted.default.bg.0}'),
          muted: {
            bg: _colorAlias('{_tone.color.tinted.default.border.3}'),
            border: _colorAlias('{_tone.color.tinted.default.border.2}'),
            fg: _colorAlias('{_tone.color.tinted.default.bg.0}'),
    ...
    button: {
      ...
      color: _defineTokenGroup({
        ...
        disabled: {
          ...
          border: _colorAlias('{_tone.color.tinted.default.border.0}'),
          fg: _colorAlias('{_tone.color.tinted.default.border.4}'),
          muted: {
            bg: _colorAlias('{_tone.color.tinted.default.bg.1}'),
            border: _colorAlias('{_tone.color.tinted.default.border.0}'),
            fg: _colorAlias('{_tone.color.tinted.default.border.2}'),
          },
        },
      }),
    },
