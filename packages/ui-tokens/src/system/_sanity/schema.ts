...
import {DTCGDimensionTokenSchema, DTCGNumberTokenSchema} from '../_dtcg/schema'
...
/** @internal */
export const SanityDimensionTokenSchema = DTCGDimensionTokenSchema.and(
  z.object({
...
/** @internal */
export const SanityNumberTokenSchema = DTCGNumberTokenSchema.and(
  z.object({
