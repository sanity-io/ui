// import type {DTCGColorValue} from '@sanity/ui-tokens/types'
 ...
 * @param color1 First color (DTCGColorValue or token reference string)
 * @param color2 Second color (DTCGColorValue or token reference string)
 ...
 * @returns Mixed color as DTCGColorValue
 * @internal
 */
